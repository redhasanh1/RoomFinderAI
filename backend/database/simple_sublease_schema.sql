-- SIMPLE SUBLEASE MATCHING SCHEMA - No RLS, just the tables
-- Run this SQL in your Supabase SQL Editor

-- Step 1: Create the user context function
...
-- Step 2: Create sublease_requests table
...
-- Step 3: Create sublease_matches table
...
-- Success message
SELECT 'Sublease matching tables created successfully!' as result;