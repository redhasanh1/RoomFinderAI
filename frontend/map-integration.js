    ...
    createPopupContent(listing) {
        return `
            <div style="min-width: 200px; font-family: Arial, sans-serif;">
                ...
                <a href="/listing_details?id=${listing.id}" style="background: #4f46e5; color: white; padding: 6px 12px; border-radius: 4px; text-decoration: none; font-size: 12px; font-weight: 500;">View Details</a>
            </div>
        `;
    }
