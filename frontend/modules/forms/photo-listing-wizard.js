                    ...
                    <div class="photo-wizard-content relative bg-white rounded-2xl shadow-2xl w-full max-w-lg transform transition-all">
                        ...
                        <div id="wizardStep1" class="p-8">
                            ...
                            <div class="mt-6 pt-4 border-t border-gray-200">
                                <button id="skipToManualBtn" class="w-full flex items-center justify-center gap-2 px-4 py-3 bg-gray-50 hover:bg-gray-100 border border-gray-200 rounded-xl text-gray-600 hover:text-gray-800 font-medium transition-all group">
                                    ...
                                    <span>Skip and fill manually</span>
                                </button>
                            </div>
                        </div>
