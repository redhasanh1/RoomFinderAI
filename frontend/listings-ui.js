    ...
    listingCard.innerHTML = `
        ...
        <div class="p-4">
            ...
            <div class="flex space-x-2">
                <button 
                    class="view-details-btn flex-1 bg-blue-600 hover:bg-blue-700 text-white px-4 py-2 rounded-lg transition-colors duration-200 font-semibold shadow-md hover:shadow-lg"
                    data-listing='${JSON.stringify(listing)}'
                    title="View full details">
                    View Details
                </button>
                <button 
                    class="chat-btn flex-1 ${hasOwner ? 'bg-green-600 hover:bg-green-700' : 'bg-gray-400 cursor-not-allowed'} text-white px-4 py-2 rounded-lg transition-colors duration-200 font-semibold shadow-md hover:shadow-lg"
                    data-listing='${JSON.stringify(listing)}'
                    ${hasOwner ? '' : 'disabled'}
