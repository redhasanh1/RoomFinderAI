            ...
            listingCard.innerHTML = `
                ...
                <div class="p-4">
                    ...
                    <div class="flex space-x-2 mt-4">
                        <button class="view-details-btn bg-purple-600 hover:bg-purple-700 text-white px-3 py-2 rounded-lg transition font-semibold shadow-md hover:shadow-lg flex-1" data-listing-id="${listing.id}">View Details</button>
                        <button class="chat-btn ${hasOwner ? 'bg-blue-600 hover:bg-blue-700' : 'bg-gray-400 cursor-not-allowed'} text-white px-3 py-2 rounded-lg transition font-semibold shadow-md hover:shadow-lg flex-1" data-listing-id="${listing.id}" ${hasOwner ? '' : 'disabled title="No owner specified for this listing"'}>Chat</button>
