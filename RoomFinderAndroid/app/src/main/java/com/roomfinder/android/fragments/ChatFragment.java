...
public class ChatFragment extends Fragment {
    ...
    private void navigateToAiChat() {
        try {
            ...
            // The negotiator opens for everyone, as it does on iOS: you can read
            // what it is and see the suggestions before signing in. Sending is
            // where the account is actually needed, and AiChatFragment asks
            // there. Gating the whole screen meant a guest tapping the app's
            // headline feature got a dialog instead of the feature.
            if (true) {
    ...
    private void showLoginRequiredDialog() {
        new MaterialAlertDialogBuilder(requireContext())
                ...
                .setIcon(R.drawable.ic_ai_negotiator)
                .show();
    }
