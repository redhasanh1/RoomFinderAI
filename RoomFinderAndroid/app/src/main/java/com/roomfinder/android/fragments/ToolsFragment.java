...
public class ToolsFragment extends Fragment {
    ...
    private void setupClickListeners() {
        // People: RoomPal and subleases. This tile used to open Student
        // Housing, which was removed from the website entirely.
        studentHousingCard.setOnClickListener(v -> navigateToPeople());
    ...
    private void navigateToPeople() {
        if (getActivity() instanceof MainActivity) {
            ((MainActivity) getActivity()).navigateToTab(R.id.navigation_search);
        }
    }
