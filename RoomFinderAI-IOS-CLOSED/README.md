...
> **TEMPORARILY CLOSED** — Folder `RoomFinderAI-IOS-CLOSED/`. Not on App Store or TestFlight. Use **[roomfinderai.com](https://www.roomfinderai.com)**. See [`PLATFORMS_LOCKED.md`](PLATFORMS_LOCKED.md) and [`DOCUMENTATION.md`](../DOCUMENTATION.md).
