...
struct ListingsView: View {
    ...
    var body: some View {
        NavigationView {
            ...
            .alert("Error", isPresented: .constant(listingsViewModel.hasError)) {
                Button("OK") {
            ...
            VStack(alignment: .leading, spacing: 12) {
                ...
                VStack(alignment: .leading, spacing: 8) {
                    ...
                    HStack {
                        ...
                        HStack(spacing: 12) {
                            ...
                            if let sqft = listing.squareFootage {
                                Label("\(Int(sqft))", systemImage: "square.grid.3x3")
                            }
                        }
                        .font(.caption)
                        .foregroundColor(.secondary)
                    ...
                    HStack {
                        ...
                        Text("Available \(listing.availableDate.formatted(style: .abbreviated))")
                            .font(.caption)
                            .foregroundColor(.secondary)
                    }
                }
